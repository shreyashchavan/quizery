...
game:
     ...
     switch(r)
		...
		printf("\n\nA.No compile error and it will print 1 2 0 0\t\tB.Compile error because of initialization of array of struct i.e. arr[]\n\nC.No compile error and it’ll print 1 0 2 0\t\tD.Error");
		if (toupper(getch())=='C')
	...
	{
	    printf("\n\n\n \t\t**************** CONGRATULATION ****************");
	    printf("\n\t\t\t\t YOU ARE A BEST CODER :)");
	    printf("\n\t\t You won $%.2f",score);
	    printf("\t\t Thank You!!");
	}
	else
    {
	    printf("\n\n\t******** SORRY YOU DIDN'T WIN Game ********");
...
void get_score()  // simple file system used for storing data
    {
		system("cls");
		char name[20];
		float scr;
...
void reset_score()  // reset your score
    {
		system("cls");
		float sc;
		char nm[20];
